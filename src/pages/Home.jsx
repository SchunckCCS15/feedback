  ...
  return (
    aparecerResultado === false ? (
      <CardContainer>
        ...
        <CardContainer>
          <img src={ thankYou } alt="Imagen de agradecimento" />
          ...
          <h1>Obrigado!</h1>
          <p>Agradecemos por dedicar um momento para nos avaliar. Se precisar de mais suport, não hesite em entrar em contato!</p>
        </CardContainer>
    )
  )
}
